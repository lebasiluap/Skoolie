...
/** Password field with a show/hide (eye) toggle. Forwards its ref to the
 *  underlying TextInput so keyboard "next" chains can focus it. */
export const PasswordInput = forwardRef<TextInput, Props>(function PasswordInput(
  { inputStyle, containerStyle, ...props },
  ref,
) {
  const C = useTheme()
